...
$photo_folder = 'sell/' . $photo_name1;
$photo_folder = 'sell/' . $photo_name2;
...
if (move_uploaded_file($photo_temp_name, $photo_folder) && move_uploaded_file($photo_temp_name1, $photo_folder) && 
move_uploaded_file($photo_temp_name2, $photo_folder) &&
...
$sql = "INSERT INTO property (title, contact_info, location, price, photo,photo1,photo2,ownership_documents_path, lease_agreement_path, username,type,description) 
        VALUES ('$title', '$contact_info', '$location', '$price', '$photo_name', '$photo_name1', '$photo_name2', '$ownership_documents_name', '$lease_agreement_name', '$username','$type','$description')";
