        ...
        ?>
            <div class="property-layout">
                <div class="property-summary">
                    ...
                    <div class="property-details">
                        ...
                        <?php if ($row['type'] == 'Rent') { ?>
                            <p class="price"><strong>Price:$</strong> <?php echo number_format($row['price'], 2); ?>/month</p>
                        <?php } else { ?>
                ...
                <div class="image-box">
                    ...
                    <img src="sell/<?php echo htmlspecialchars($row['photo3']); ?>" alt="Property Image 3">
                    <img src="sell/<?php echo htmlspecialchars($row['photo4']); ?>" alt="Property Image 4">
                    <img src="sell/<?php echo htmlspecialchars($row['photo5']); ?>" alt="Property Image 5">
                </div>
            </div>
        <?php
        } else {
