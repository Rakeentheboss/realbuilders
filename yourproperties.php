...
<head>
    ...
    padding: 12px 30px;
    background: linear-gradient(135deg, #f06, #ff6a00); /* Gradient from pink to orange */
    color: white;
    font-size: 16px;
    font-weight: 500;
    border-radius: 25px;
...
.colorful-button:hover {
    background: linear-gradient(135deg, #ff6a00, #f06); /* Reverse gradient on hover */
...
<body>
    ...
    <section class="section">
        ...
        <h3> The Following Properties are for sale</h3>
        <a href="sell.html" class="colorful-button">Sell a new property</a>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form action="update.html" method="POST">
                            ...
                            <button type="submit" class="view-details">Update</button>
            </form>
    ...
    <section class="section">
        <h3>The Following Properties are Available for Rent</h3>
        <a href="sell.html" class="colorful-button">Rent a new property</a>
